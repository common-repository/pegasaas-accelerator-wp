<?php $progress = $pegasaas->interface->get_progress("cpcss"); ?>
<div class='speed-info-box' id='pegasaas-pending-cpcss-scans-chart'>
	<h3>Critical Path CSS <i class='fa fa-question-circle-o pending-cpcss-scans-chart-tooltip'></i></h3>
	<div class="progress">
